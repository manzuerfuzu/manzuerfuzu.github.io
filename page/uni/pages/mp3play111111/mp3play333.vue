<template>
	<view class="content">
		...
		<view class="">
			<button type="default" @click="getcurrentTime()">播放时间</button>
			{{zongtime}}
			
		</view>
		<!-- <view class="">最新：{{getcurrentTime()}}</view> -->
		<view class="">当前播放时间为:{{m1}}分{{s1}}秒</view>
		<view class="">	{{dangqiantime}} </view>
		<!-- <text v-model="xszong"></text> -->
		<!-- <text>\n当前播放的课程时长为：{{m}} 分 {{s}} 秒 \n</text> -->
		...
		<button type="primary" @click="stop();play(1);getcurrentTime()">20200926【1蒙以养正】</button>
		<button type="primary" @click="stop();play(2);getcurrentTime()">20201002【2必有余庆】</button>
		<button type="primary" @click="stop();play(3);getcurrentTime()">20201005【3爱美之心】</button>
		<button type="primary" @click="stop();play(4);getcurrentTime()">20201007【4原生家庭】</button>
